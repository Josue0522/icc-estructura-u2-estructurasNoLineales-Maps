...
public class App {
    ...
    private static void runEmpleadoExample() {
        EmpleadoContoller empCont = new EmpleadoContoller();
        empCont.addEmpleado(new Empleado(1, "Josué", "Developer"));
        empCont.addEmpleado(new Empleado(2, "Patricio", "Designer"));
        empCont.addEmpleado(new Empleado(3, "Hugo", "Analyser"));
        empCont.addEmpleado(new Empleado(4, "Xavier", "Tester"));

        empCont.imprimirEmpleados();
    }
